<div class="page-header">
    <div class="header-wrapper row m-0">
        <div class="header-logo-wrapper col-auto p-0">
            ...
            <div class="logo-header-main"><a href="index.html"><img class="img-fluid for-light img-100" src="{{ asset("backend/assets/images/logo/logo2.png") }}" alt=""><img class="img-fluid for-dark" src="{{ asset("backend/assets/images/logo/logo.png") }}" alt=""></a></div>
        </div>
            ...
            <ul class="nav-menus">
                    ...
                    <ul class="message-dropdown onhover-show-div">
                        ...
                        <li>
                            <div class="d-flex align-items-start">
                                <div class="message-img bg-light-primary"><img src="{{ asset("backend/assets/images/user/3.jpg") }}" alt=""></div>
                                <div class="flex-grow-1">
                ...
                <li class="profile-nav onhover-dropdown">
                    ...
                    <ul class="profile-dropdown onhover-show-div">
                        <li><a href="{{ route("admin.profile") }}"><i data-feather="user"></i><span>Profilim</span></a></li>
        ...
        <script class="result-template" type="text/x-handlebars-template">
            <div class="ProfileCard u-cf">
                ...
                <div class="ProfileCard-details">
                    <div class="ProfileCard-realName">Emre</div>
                </div>
            </div>
        </script>
